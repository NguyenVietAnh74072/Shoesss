        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                        <a href="{{route('get_backend.keyword.index')}}" class="btn add-btn" data-toggle="" data-target="#add_client"><i class="fa fa-plus"></i>Quay lại</a>
                </div>
            </div>
        </div>
       
        
          <form   action="{{route('get_backend.keyword.update',$keyword->id)}}"  method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <label ><h3>Số ID {{$keyword->id}}</h3></label>
                    <div class="form-group">
                        <label class="col-form-label">Tên<span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name='k_name' value='{{old('k_name',$keyword->k_name ??'')}}' >
