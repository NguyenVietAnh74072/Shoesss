...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Mar 2021 14:22:07 GMT -->
<head>
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="{{asset('./backend/css/vendors/fontawesome.css')}}">
    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none w-auto">
                <div class="logo-wrapper"><a href="index-2.html"><img class="blur-up lazyloaded" src="/backend/images/dashboard/multikart-logo.png" alt=""></a></div>
            </div>
            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="/backend/images/dashboard/man.png" alt="header-user">
        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    <div><img class="img-60 rounded-circle lazyloaded blur-up" src="/backend/images/dashboard/man.png" alt="#">
                    </div>
                ...
                <div class="p-l-30 p-r-30">
                    <div class="chat-box">
                        <div class="people-list friend-list">
                            <ul class="list">
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/user.png" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/user1.jpg" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/user2.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/user3.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/man.png" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/user5.jpg" alt="">
                                    <div class="status-circle away"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="/backend/images/dashboard/designer.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                    ...
                                    <table class="table table-bordernone mb-0">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="/backend/images/dashboard/user2.jpg" alt="" data-original-title="" title="">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="/backend/images/dashboard/user1.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="/backend/images/dashboard/man.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="/backend/images/dashboard/user.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="/backend/images/dashboard/designer.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
...
<!--chartjs js-->
<script src="/backend/js/chart/chartjs/chart.min.js"></script>
...
<!--peity chart js-->
<script src="/backend/js/chart/peity-chart/peity.jquery.js"></script>

<!--sparkline chart js-->
<script src="/backend/js/chart/sparkline/sparkline.js"></script>

<!--Customizer admin-->
<script src="/backend/js/admin-customizer.js"></script>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Mar 2021 14:22:58 GMT -->
</html>
