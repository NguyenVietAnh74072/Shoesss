      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="/product/{{$pro->product_image}}" height="100" width="100"</td>
            ...
            <td>
              ...
              <i class="fa fa-pencil-square-o text-sucess text-active"></i></a>
              <a onclick="return confirm('bạn chắc chắn chứ?')" href="{{URL::to('delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
