...
<!-- Mirrored from p.w3layouts.com/demos/sep-2016/15-09-2016/fashion_club/web/men.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 14:38:03 GMT -->
									...
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href="{{URL::to('vans')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>vans</a></li>
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="vans"><i class="fa fa-angle-right" aria-hidden="true"></i>Casuals</a></li>
			...
			<div class="w3ls_dresses_grid_left_grid">
				...
				<div class="w3ls_dresses_grid_left_grid_sub">
					<div class="ecommerce_color">
						...
						<ul>
							<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->brand_id)}}"><i></i>{{($brand->brand_name)}}</a></li>
...
<!-- Mirrored from p.w3layouts.com/demos/sep-2016/15-09-2016/fashion_club/web/men.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 14:38:21 GMT -->
</html>
