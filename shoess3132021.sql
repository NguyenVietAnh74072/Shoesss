...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 30, 2021 lúc 07:40 PM
...
(1, 'Giày nam', 'Giày nam', NULL, NULL, NULL, 0, 1, NULL, NULL),
(2, 'Giày nữ', 'Giày nữ', NULL, NULL, NULL, 0, 1, NULL, NULL);
...
CREATE TABLE `menus` (
  ...
  `mm_hot` tinyint(4) NOT NULL DEFAULT 0,
...
INSERT INTO `menus` (`id`, `mn_name`, `mn_slug`, `mn_avatar`, `mn_banner`, `mn_description`, `mm_hot`, `mn_status`, `created_at`, `updated_at`) VALUES
(1, 'Hướng dẫn', 'huong-dan', NULL, NULL, NULL, 0, 1, NULL, NULL),
(2, 'Thông báo', 'thong-bao', NULL, NULL, NULL, 0, 1, NULL, NULL);
...
(20, '2020_12_25_174303_create_tbl_admin_table', 1),
(21, '2020_12_27_184339_create_tbl_category_product', 1),
(22, '2020_12_28_044258_create_tbl_brand_product', 1),
(23, '2020_12_28_054535_create_tbl_product', 1),
(24, '2021_03_24_145825_create_tags_table', 1),
(25, '2021_03_24_145840_create_articles_table', 1),
(26, '2021_03_24_145856_create_categories_table', 1),
(27, '2021_03_24_145909_create_keywords_table', 1),
(28, '2021_03_24_145919_create_products_table', 1),
(29, '2021_03_24_154103_create_products_keywords_table', 1),
(30, '2021_03_24_160442_create_admins_table', 1),
(31, '2021_03_24_160542_create_menus_table', 1),
(32, '2021_03_24_160643_create_articles_tags_table', 1);
...
CREATE TABLE `tags` (
  ...
  `t_slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `t_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- AUTO_INCREMENT cho bảng `articles_tags`
--
ALTER TABLE `articles_tags`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
